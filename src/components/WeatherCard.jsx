      ...
      <div className="border-solid border-2 border-black flex flex-col bg-white rounded p-4 w-full max-w-xs">
        ...
        <div className="flex flex-row justify-between mt-6">
          <div className="flex flex-col items-center">
            ...
            <div className="text-sm text-gray-500">{wind.speed} km/h</div>
          </div>
          <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-sm text-gray-500">{main.pressure}</div>
          </div>
        </div>
        <div className="flex flex-row justify-between mt-6">
          <div className="flex flex-col items-center">
            <div className="font-medium text-sm">Visibility</div>
            <div className="text-sm text-gray-500">{info.visibility}ft</div>
          </div>
          <div className="flex flex-col items-center">
